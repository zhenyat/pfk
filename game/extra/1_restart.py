...
#   2_game_over.py
#
#   Python for Kids, Extra code: Geme over message
#
...
btn = Button(tk, text = 'restart', command = restart).pack()  # 1-1

tk.update()   # Initializes itself for the game animation

paddle = Paddle(canvas, 'blue')
ball   = Ball(canvas, paddle, 'red')
text   = canvas.create_text(250, 200, text='GAME OVER', state='hidden')
